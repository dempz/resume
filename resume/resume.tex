...
%    \resumeItemListEnd
    ...
    \resumeItemListStart
    \resumeItem{}{Facilitator of laboratories for STAT1520: Economics and Business Statistics for the School of Mathematics and Statistics. Unit establishes a foundational understanding in discrete and continuous random variables, sampling, ANOVA, and linear modelling techniques.}
    \resumeItem{}{Coordinated multiple in-person classes each week, coaching students of a non-science background through a range of fundamental and extension questions aimed to develop skills in fundamental statistical analysis.}
    \resumeItem{}{Marker of assessment items (e.g., tests, exams).}
    \resumeItemListEnd
    ...
    \resumeItem{}{Construct company valuation models (e.g., discounted cash flow, comparable companies/transactions analysis) informed by qualitative findings.}
    \resumeItemListEnd
